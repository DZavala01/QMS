                ...
                <form action="#" method="POST" enctype="multipart/form-data" class="col-12">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2">
                            ...
                            <a href="<?php echo e(route('problemasoluciones.create')); ?>" type="submit" class="btn btn-success"><i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\QMS\resources\views/problemas_soluciones/index.blade.php ENDPATH**/ ?>