...
<body>
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar" class="active">
            <a href="<?php echo e(route('welcome')); ?>" class="logo">
                <img src="<?php echo e(asset('/images/sgc-white-version.png')); ?>" class="w-100">
            </a>
            <ul class="list-unstyled components mb-5">
                <li class="active">
                    <a href="<?php echo e(route('welcome')); ?>"><span class="fa fa-home"></span> Home</a>
                </li>
                <li>
                    <a href="<?php echo e(route('problemasoluciones.index')); ?>"><span class="fa fa-user"></span> Problemas y
                        soluciones</a>
                </li>
                <li>
    ...
    <script src="<?php echo e(asset('js/core/main.js')); ?>" type="text javascript"></script>
...
<?php /**PATH C:\xampp\htdocs\QMS\resources\views/layouts/app.blade.php ENDPATH**/ ?>